...
import { MoveRight, Sparkles, ShoppingCart, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute top-1/4 left-20 hidden lg:block">
        <ShoppingCart className="h-12 w-12 text-green-500/30" />
      </div>
        ...
        <div className="flex flex-col items-center">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-glow mb-6">
              Grow Your <span className="text-green-500">Business</span> Online
            </h1>
            
            <p className="text-xl text-gray-300 mb-8">
              Transform your business with custom ecommerce solutions. From Shopify development to digital marketing, we help you build and scale your online presence.
            </p>
