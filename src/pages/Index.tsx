...
import { Megaphone, Palette, Smartphone, ShoppingCart, MoveRight, TrendingUp, Store, Globe } from "lucide-react";
  ...
  const featuredServices = [
    {
      ...
      description: "Drive traffic and boost sales with data-driven digital advertising campaigns across all platforms.",
    ...
    },
    {
      ...
      description: "Custom Shopify themes that represent your brand and optimize for maximum conversions.",
    ...
    },
    {
      ...
      description: "Extend your store's functionality with custom apps tailored to your business needs.",
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12">
            <div>
              ...
              <p className="text-gray-400 max-w-2xl">
                Complete ecommerce solutions to grow your online business and maximize revenue
              </p>
            </div>
            <Link 
              to="/services"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              We provide custom ecommerce solutions for businesses of all sizes and industries
            </p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {[
              { name: "Retail", icon: <ShoppingCart size={32} /> },
              { name: "Fashion", icon: <Palette size={32} /> },
              { name: "Electronics", icon: <Smartphone size={32} /> },
              { name: "B2B", icon: <TrendingUp size={32} /> }
            ].map((business, index) => (
              <div 
                key={index}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto mb-8">
              Transform your business with our comprehensive ecommerce solutions. From custom development to digital marketing, we're here to help you succeed online.
            </p>
